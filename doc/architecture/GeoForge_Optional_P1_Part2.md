# GIS-Forge 可选功能包完整接口设计 — P1 核心 3D 包（下）

> view-morph / layer-3dtiles

---

## 3. @gis-forge/view-morph

### 3.1 类型依赖

```typescript
import type { CameraController, CameraAnimation } from '@gis-forge/runtime';
import type { CameraState, Mat4f, Vec3f, Viewport } from '@gis-forge/core';
...
import { lngLatToMerc, mercToLngLat } from '@gis-forge/core/geo/mercator';
import { geodeticToECEF, ecefToGeodetic } from '@gis-forge/core/geo/ellipsoid';
```
...
## 4. @gis-forge/layer-3dtiles

### 4.1 类型依赖

```typescript
import type { Layer, LayerContext } from '@gis-forge/scene';
import type { CameraState, CameraController, Vec3f, Mat4f, BBox3D, Viewport, Feature } from '@gis-forge/core';
import type { BufferHandle, TextureHandle } from '@gis-forge/gpu';
import type { CameraAnimation } from '@gis-forge/runtime';
import type { InternalBus } from '@gis-forge/core/infra/internal-bus';
