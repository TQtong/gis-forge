...
> 涉及引擎：CesiumJS / cesium-unreal / cesium-unity / GeoForge
...
## 二、GeoForge 当前方案——全屏三角形 + ray-sphere（蛋形根因）
