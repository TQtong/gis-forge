# GIS-Forge：新一代 2D/2.5D/3D 统一 WebGPU GIS 引擎 — 完整设计文档
...
**B 的双坐标骨架 + C 的场景分层 + D 的投影 Shader + E 的功能级拆包** = GIS-Forge 架构。
...
// 5行代码出3D地球
import { Globe } from '@gis-forge/preset-3d';
...
| 包 | 层 | 体积 |
|---|---|------|
| @gis-forge/core | L0 | ~10KB |
| @gis-forge/gpu | L1+L2 | ~30KB |
| @gis-forge/runtime | L3 | ~15KB |
| @gis-forge/scene | L4 | ~12KB |
