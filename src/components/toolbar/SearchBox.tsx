 ...
 */
export function SearchBox({ onFlyTo }: SearchBoxProps = {}): ReactElement {
    const flyTo = onFlyTo ?? ((_center: [number, number], _zoom?: number) => undefined);
