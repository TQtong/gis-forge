...
import { ChevronDown, Hand, MousePointer, Pencil, Ruler } from 'lucide-react';
...
type OpenMenu = 'none' | 'select' | 'draw' | 'measure';

const ICON_SIZE = 18;

/**
 * Mutually exclusive map tools: pan / select / draw / measure。分析入口见 {@link AnalysisMenu}。
 * 无全局 store 时使用本地 `activeTool`（后续可接入 mapStore）。
 *
